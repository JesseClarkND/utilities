...
namespace Clark.Attack.ContentScanner
{
    ...
    {
        public string Name { get { return "Content Scanner"; } set {} }
        #region Private
        private static List<Fingerprint> _serviceFingerPrints = new List<Fingerprint>()
        {
           new Fingerprint(){
                Name = "Whitelabel Error Page",//
                Fingerprints = new List<string>() { "Whitelabel Error Page" },
                Reference = "https://hawkinsecurity.com/2017/12/13/rce-via-spring-engine-ssti/"
            },
            new Fingerprint(){
                Name = "Jenkins",
            ...
            new Fingerprint(){
                Name = "Github SSO",
                Fingerprints = new List<string>() { "New to GitHub?"},
                Reference = ""
            }
        };
        ...
        private static List<Fingerprint> _subDomainFingerPrints = new List<Fingerprint>()
        {
            ...
            new Fingerprint(){
                Name = "Cloudfront",
                Fingerprints = new List<string>() { "Bad Request: ERROR: The request could not be satisfied", "Generated by cloudfront" },
        ...
        private static List<Fingerprint> _defaultPageFingerPrints = new List<Fingerprint>()
        {
            ...
            new Fingerprint(){
                Name = "EMC2",
                Fingerprints = new List<string>() { "EMC Unisphere was started in a separate window." },
                Reference = ""
            },
        };
        ...
        private static List<Fingerprint> _indexOfFingerPrints = new List<Fingerprint>()
        {
            new Fingerprint(){
                ...
                Fingerprints = new List<string>() { "<title>Index of", "- /</title>" },
                Reference = ""
            },
        };
        #endregion
        ...
        private void CheckFingerprints(AttackResult result, string body, List<Fingerprint> fingerPrints, string message)
        {
            foreach (var fp in fingerPrints)
            {
                ...
                {
                    result.Success = true;
                    result.Results.Enqueue(fp.Name + " - Default Page found");
                }
            }
        }
